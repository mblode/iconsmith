...
const MessageHeader = ({ className, ...props }: React.ComponentProps<"div">) => (
  <div
    className={cn(
      "flex max-w-full min-w-0 items-center px-3 font-medium text-muted-foreground text-xs group-has-data-[variant=ghost]/message:px-0",
      className,
    )}
...
const MessageFooter = ({ className, ...props }: React.ComponentProps<"div">) => (
  <div
    className={cn(
      "flex max-w-full min-w-0 items-center px-3 font-medium text-muted-foreground text-xs group-data-[align=end]/message:justify-end group-has-data-[variant=ghost]/message:px-0",
      className,
    )}
