...
- **One build entry**: `tsdown.config.ts` produces `dist/cli.js` with a shebang. Internal scripts import source by relative path; there is no package API or website entrypoint.
