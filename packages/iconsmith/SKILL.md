...
A heart. House compile is one evenodd compound of two lobes and a point. Outlined is that silhouette, not three circles. Filled is the same compound, not a disc and not three circles restamped as solids.
