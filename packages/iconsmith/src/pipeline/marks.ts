...
export const plus = (slug: string, finish: Finish): string =>
  program(slug, finish, "square", [
    hbar(finish, 4, 12, 16),
    vbar(finish, 12, 4, 16),
  ]);

export const minus = (slug: string, finish: Finish): string =>
...
export const equal = (slug: string, finish: Finish): string =>
...
export const hamburgerMenu = (slug: string, finish: Finish): string =>
...
export const moreVertical = (slug: string, finish: Finish): string =>
  program(slug, finish, null, [
    "dot 12,6 node",
    "dot 12,12 node",
    "dot 12,18 node",
...
export const viewGrid = (slug: string, finish: Finish): string =>
...
export const battery = (slug: string, finish: Finish): string =>
...
export const ban = (slug: string, finish: Finish): string =>
  program(slug, finish, "square", [
    ...ring(finish, 12, 12, 8),
    "line 6,6 18,18 off-axis",
  ]);

export const timeline = (slug: string, finish: Finish): string =>
...
export const flag = (slug: string, finish: Finish): string =>
